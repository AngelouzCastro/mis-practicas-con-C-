...
namespace Diseño_Gym_Hulk.Logica
{
    class ControlVentas
    {
        ...
        {
            String SQL = "insert into venta_membresia values (null,'?1','?2','?3','?4','?5')";
        ...
        {
            String SQL = "select * from  venta_membresia  where Fecha_inicio >= '"+ Fecha_inicio +"' and Fecha_fin <= '"+Fecha_fin+"'";
